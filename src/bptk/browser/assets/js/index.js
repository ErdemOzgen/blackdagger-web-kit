...
const controller = new bptk_controller_index()
    ...
    $(document).on("click", "#generate_report", function () {
        ...
        browser.storage.local.set({
            ...
            browser.windows.create({
                type: 'popup',
                url: browser.runtime.getURL("/bptk/browser/report.html?full_report")
            })
...
browser.runtime.onMessage.addListener(function (message, sender, sendResponse) {
    ...
    if (message.channel == "bptk_content2popup" && message.type == "init_complete") {
    ...
    if (message.channel == "bptk_background2popup_dashboard") {
