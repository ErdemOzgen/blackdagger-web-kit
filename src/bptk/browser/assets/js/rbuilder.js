/* Author: ErdemOzgen */
import { bptk_controller_rbuilder } from "../../../controller/rbuilder.js"
...
const controller = new bptk_controller_rbuilder()
...
class rbuilderUI {
    ...
    getOpts() {
        ...
        let title = bptk_utils.escapeHtml($('.menu_item.active').text())
...
browser.runtime.onMessage.addListener(function (message, sender, sendResponse) {
    if (message.channel == "bptk_background2popup_rattacker") {
        if (message.type == "attack completed") {
            rbuilder.bindAttackProgress(message)
        }
    }
    if (message.channel == "bptk_background2popup_rbuilder") {
