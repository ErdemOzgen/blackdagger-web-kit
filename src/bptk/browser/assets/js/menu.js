            ...
            <div class="ui container" id="mainMenu">
                ...
                <div class="ui dropdown item" style="position: absolute;width: 30px;height: 30px;right: 3px;top: 3px;padding: 0px;">
                    ...
                    <div class="menu top_right_icon" style="margin-top: 0px !important; min-height: 90px;top: 34px;">
                        ...
                        <div class="ui fitted divider"></div>
                        <a class="item" href="https://github.com/ErdemOzgen/howto.html" target="_blank">How to<i class="external square right floated icon"></i></a>
                        <a class="item" href="https://github.com/ErdemOzgen/release_notes.html" target="_blank">Release notes<i class="external square right floated icon"></i></a>
                        <div class="ui fitted divider"></div>
    ...
    $('#footer_menu').prepend(
        ...
        <div class="ui mini orange message"
            ...
            <i class="exclamation circle icon"></i><a target="_blank"
                href="https://www.true-positives.com/bptk-community">Please help us
                improve the BPTK</a>
        </div>
