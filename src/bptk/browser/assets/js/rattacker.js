...
const controller = new bptk_controller_rattacker()
const request_controller = new bptk_controller_rbuilder()
...
jQuery(function () {
    ...
    $(document).on("click", ".generate_report", function () {
        browser.windows.create({
            type: 'popup',
            url: browser.runtime.getURL("/bptk/browser/report.html?rattacker_report")
        })
    })
