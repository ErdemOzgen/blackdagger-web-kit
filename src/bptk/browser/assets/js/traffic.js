...
import { bptk_controller_traffic } from "../../../controller/traffic.js"
const controller = new bptk_controller_traffic()
...
jQuery(function () {
    ...
    $('.traffic_download').on('click', function () {
        try {
            ...
            var fName = "BPTK_traffic.har"
            let url = controller.recording.startUrl;
            if (url) {
                fName = 'BPTK_' + (new URL(url)).hostname + '.har'
            }
