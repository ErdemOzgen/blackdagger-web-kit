...
import { bptk_request } from "../../background/rbuilder.js"
import { bptk_module } from "../../modules/module.js"
import { bptk_rattacker } from "../../background/rattacker.js"
...
await fetch('../../modules/modules.json')
    ...
    .then(json => {
        Object.values(json.modules).forEach(module => {
            modules.push(new bptk_module(module))
        })
    })
...
password=test&username=test`
    ...
    let rattacker = new bptk_rattacker()
