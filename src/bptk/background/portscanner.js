...
export class bptk_portscanner {
    constructor() {
        this.storageKey = "bptk_portscanner"
    ...
    onMessage(message, sender, sendResponse) {
        ...
        if (message.channel == "bptk_popup2background_portscanner") {
    ...
    async msg_save(message) {
        this.storage = bptk_storage.setItem(this.storageKey, {target: message.target, ports: message.ports})
        return Promise.resolve(Object.assign({}, worker.bptk_app.proxy.activeTab))
    }
