...
export class bptk_decoder_manager {
    constructor() {
        this.storageKey = "bptk_decoder"
        this.storage = {}
    ...
    onMessage(message, sender, sendResponse) {
        ...
        if (message.channel == "bptk_popup2background_decoder") {
